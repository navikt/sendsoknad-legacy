...
public class SamlingReiseTilXmlTest {
    ...
    public void skalKonvertereFaktumStrukturMedRiktigPeriodeForToPerioder() {
        ...
        ReiseObligatoriskSamling samling = SamlingReiseTilXml.transform(soknad);
    ...
    public void skalKonvertereFaktumStruktur() {
        ...
        ReiseObligatoriskSamling xml = SamlingReiseTilXml.transform(soknad);
        ...
        xml = SamlingReiseTilXml.transform(soknad);
