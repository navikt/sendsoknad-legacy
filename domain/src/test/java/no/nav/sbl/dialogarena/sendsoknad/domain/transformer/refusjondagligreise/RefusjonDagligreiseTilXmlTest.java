...
public class RefusjonDagligreiseTilXmlTest {
    ...
    @Test
    public void skalRegneUtParkeringsutgifterOgAntallDagerKjort() {
        Boolean trengerParkering = true;
        Faktum vedtak = settOppVedtak().medProperty("trengerParkering", trengerParkering.toString());
        Faktum betalingsplan = lagBetalingsplan("2015-01-02", "2015-01-04", trengerParkering, "2");
        betalingsplan.medProperty("2015-01-03.soker", "false");
