...
public class SjekkTilgangTilSoknadScanner {
    ...
    public void sjekkAtAlleKlasserMedSikkerhetsannotasjonHarEnKlasseHer() {
        ...
        //Metoder som mangler tester - klasse: FeatureToggleRessurs
        methods.remove("GET_hentFeatureToggles");
    ...
    private String getPrefixFromAnnotation(Method method) {
        List<Class<? extends Annotation>> annotations = Arrays.asList(GET.class, PUT.class, POST.class, DELETE.class);
        String prefix = "";
