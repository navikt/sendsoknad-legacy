...
public class HvisFaktumstrukturHarInfoteksterHelperTest {
    ...
    public void skalViseBlokkOmFaktumHarInfoteksterDefinertIStrukturMedConstraintsSomOppfylles() throws IOException {
        ...
        tekstStruktur.setConstraints(singletonList(constraint));

        faktumStruktur.setTekster(singletonList(tekstStruktur));
        ...
        String compiled = handlebars
                .compileInline("{{#hvisFaktumstrukturHarInfotekster}}harInfoTekster{{/hvisFaktumstrukturHarInfotekster}}")
                .apply(childContext);
    ...
    public void skalIkkeViseBlokkOmFaktumHarInfoteksterDefinertIStrukturMedConstraintsSomIkkeOppfylles() throws IOException {
        ...
        String compiled = handlebars
                .compileInline("{{#hvisFaktumstrukturHarInfotekster}}harInfoTekster{{else}}ikkeInfoTekst{{/hvisFaktumstrukturHarInfotekster}}")
                .apply(childContext);
